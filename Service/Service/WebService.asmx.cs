...
namespace Service
{
    ...
    public class WebService : System.Web.Services.WebService
    {
        ...
        public string[] GetEffets(string id)
        {
            ...
            SELECT COUNT(*)
            FROM avoir
            WHERE idMedicamentA = @medicaments";
            ...
            FROM effets
            JOIN avoir ON idEffet = idEffetA
            WHERE idMedicamentA = @medicaments";
        ...
        public string[] GetContreIndications(string id)
        {
            ...
            SELECT COUNT(*)
            FROM posseder
            WHERE idMedicamentP = @medicaments";
            ...
            JOIN posseder ON idContreIndication = idContreIndicationP
            WHERE idMedicamentP = @medicaments";
        ...
        public string[] GetMedicaments()
        {
            ...
            FROM medicaments
            JOIN famille ON idFamilleM = idFamille";
